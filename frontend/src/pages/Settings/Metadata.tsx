    ...
    <div>
      <div className="mb-4">
        ...
        <select
          ...
          className="w-full max-w-[400px] h-9 px-3 text-mac-body bg-[var(--bg-page)] border border-[var(--border-default)] rounded-[var(--radius-control)] text-[var(--text-primary)] focus:outline-none focus:ring-[3px] focus:ring-teal-500/70"
        >
          <option value="">Empresa toda (raiz)</option>
          {folders.map((f) => (
          ...
          {availableToAdd.length > 0 && (
            <div className="flex items-center gap-2">
              <select
                ...
                className="flex-1 max-w-[300px] h-9 px-3 text-mac-body bg-[var(--bg-page)] border border-[var(--border-default)] rounded-[var(--radius-control)] text-[var(--text-primary)] focus:outline-none focus:ring-[3px] focus:ring-teal-500/70"
              >
                <option value="">Aplicar um campo do catálogo…</option>
                {availableToAdd.map((f) => <option key={f.id} value={f.id}>{f.label}</option>)}
              </select>
